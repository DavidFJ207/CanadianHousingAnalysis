...
date: today
date-format: long
abstract: "This study examines indicators influencing Canadian housing prices through the New Housing Price Index (NHPI) and key predictors: newly constructed homes, housing absorption, GDP, CPI, and interest rates. Linear regression shows GDP and CPI as the most significant predictors, with housing absorption and interest rates playing secondary roles"
format: pdf
